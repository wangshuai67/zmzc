  ...
  layer.config({
    ...
    $('.adds').click(function(){
      ...
      layer.open({
        ...
        content: '<?php echo U('/Admin/News/category_add');?>'
    ...
    $('.updates').click(function(){
      ...
      layer.open({
        ...
        content: "/index.php?s=/Admin/News/category_update/id/"+sid
    ...
    $('.del').click(function(){
        ...
        layer.confirm('确定要删除 "'+ $(this).attr('sname') +'" 吗？', {icon: 3},function(){
            ...
            $.ajax({
                ...
                url: '<?php echo U('/Admin/News/category_del');?>',
