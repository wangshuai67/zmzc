...
layer.config({
	...
	<div class="x12 padding-top padding border-bottom">
		<h3 class="x3">单页管理</h3>
		<a href="<?php echo U('/Admin/News/page_add');?>" class="float-right bg-sub button icon-plus" type="button" > 添加单页</a>
      </div>
          ...
          <tbody>
            ...
            <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($vo["id"]); ?>" class="height">
              ...
              <td>
                ...
                <a href="/index.php?s=/Admin/News/page_edit/id/<?php echo ($vo["id"]); ?>" class=" button button-small bg-sub" >编辑</a>
